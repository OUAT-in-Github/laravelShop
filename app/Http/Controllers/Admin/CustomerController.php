...
class CustomerController extends Controller
{
     ...
     */
     ...
     {
         return view('admin.dashboard',['customers' => Customer::paginate(10)]);
     }
    ...
    {
        return view("admin.edit", ['customer' => $customer]);
    }
    ...
    public function update(Request $request, Customer $customer)
    {
        ...
        return redirect()->route('customers.show', $customer)->with('updateCustomer', "Customer has been added updated");
    }
